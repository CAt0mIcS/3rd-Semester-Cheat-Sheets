...
\input{src/Grundbegriffe des Elektromagnetismus/Maxwell.tex}
\input{src/Grundbegriffe des Elektromagnetismus/Elektrostatik.tex}
\input{src/Grundbegriffe des Elektromagnetismus/stationäre Ströme.tex}
\input{src/Grundbegriffe des Elektromagnetismus/Magnetostatik.tex}
\input{src/Grundbegriffe des Elektromagnetismus/Induktion.tex}
...
\input{src/Niedrigfrequente Wechselstromnetze/Zeiger.tex}
\subsection{Leistung}
\input{src/Niedrigfrequente Wechselstromnetze/Leistung.tex}
...
\end{tabular*}\\
\textbf{Leistung:} $P_{\ir em} = \int_V \Pi_{\ir em} \diff V = - \iint\limits_V \vec j(\vec r)  \vec E(\vec r) \diff V$\\
